...
for n=1:Nsteps % begin time stepping
    ...
    um3 = [k1(M-2),k1(M-1:M),k1(1:M-3)];

    fa = 1/60*(up3+9*up2+45*up1-45*um1+9*um2-um3)/dx;
    ...
    fb = 1/60*(up3+9*up2+45*up1-45*um1+9*um2-um3)/dx;
    ...
    fc = 1/60*(up3+9*up2+45*up1-45*um1+9*um2-um3)/dx;
    ...
    fd = 1/60*(up3+9*up2+45*up1-45*um1+9*um2-um3)/dx;
